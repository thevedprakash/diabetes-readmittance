...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/ris/pythonProject/diabetes-readmittance/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/ris/pythonProject/diabetes-readmittance/venv/bin/deactivate.nu'
